...
Open `http://localhost:3000` to view the dashboard. It refreshes sensor overviews every 15 seconds and supports reading-window queries, hourly summaries, and single-reading ingestion after selecting a sensor.
